...
function amarta_wplogo() {
	echo '<style type="text/css">h1 a { background-image:url(' . get_bloginfo( 'template_directory' ) . '/img/amarta-dey-logo.png) !important;background-size:100% auto !important;width:213px !important;height:29px !important; }</style>';
}
